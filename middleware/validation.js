...
// Validation pour la création/mise à jour d'un produit (Mise à jour du champ 'type')
...
  
  body('type')
    // MODIFICATION ICI : Mise à jour des types de produits pour refléter les vêtements
    .isIn(['vetement_femme', 'vetement_enfant', 'chaussure', 'accessoire_mode'])
    .withMessage('Type de produit invalide. Les types autorisés sont : vêtement femme, vêtement enfant, chaussure, accessoire de mode.'),
  
  body('stock')
    .optional()
...
  
  // J'ai conservé le champ 'attributes.material' mais l'ai rendu optionnel ou à adapter. 
  // Vous pourriez le modifier si vous avez des attributs spécifiques aux vêtements.
  body('attributes.material') 
    .optional()
    .isIn(['coton', 'laine', 'synthétique', 'cuir', 'autre']) // Exemple d'adaptation des matériaux
